...
class Category(models.Model):
    ...
    status = fields.CharEnumField(CategoryStatus, default=CategoryStatus.ACTIVE, index=True)
...
Category_Pydantic = pydantic_model_creator(Category, name="Category", exclude=("deleted_at",))
